		...
		Commands: []commandSpec{
			...
			},
			{
				...
				Options: []optionSpec{
					...
					{Name: "--width-mm", Required: false, Description: "Optional total table width in millimeters."},
					{Name: "--height-mm", Required: false, Description: "Optional total table height in millimeters."},
					{Name: "--col-widths-mm", Required: false, Description: "Optional comma-separated column widths in millimeters."},
					{Name: "--row-heights-mm", Required: false, Description: "Optional comma-separated row heights in millimeters."},
					{Name: "--margin-left-mm", Required: false, Description: "Optional left outer margin in millimeters."},
					{Name: "--margin-right-mm", Required: false, Description: "Optional right outer margin in millimeters."},
					{Name: "--margin-top-mm", Required: false, Description: "Optional top outer margin in millimeters."},
					{Name: "--margin-bottom-mm", Required: false, Description: "Optional bottom outer margin in millimeters."},
					{Name: "--format", Values: []string{"text", "json"}, Description: "Selects human or machine-readable output."},
				},
				Examples: []string{
			...
			},
			{
				...
				Options: []optionSpec{
					...
					{Name: "--cells", Required: false, Description: "Semicolon/comma matrix. Example: a,b;c,d"},
					{Name: "--width-mm", Required: false, Description: "Optional total nested table width in millimeters."},
					{Name: "--height-mm", Required: false, Description: "Optional total nested table height in millimeters."},
					{Name: "--col-widths-mm", Required: false, Description: "Optional comma-separated column widths in millimeters."},
					{Name: "--row-heights-mm", Required: false, Description: "Optional comma-separated row heights in millimeters."},
					{Name: "--margin-left-mm", Required: false, Description: "Optional left outer margin in millimeters."},
					{Name: "--margin-right-mm", Required: false, Description: "Optional right outer margin in millimeters."},
